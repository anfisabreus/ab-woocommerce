 ...
 * @extends  WC_Widget
 */
class AB_WC_Widget_Price_Filter extends WC_Widget {
		...
		echo '<form method="get" action="' . esc_url( $form_action ) . '">
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<button type="submit" class="button">' . __( 'ОК', 'woocommerce' ) . '</button>
					<div class="price_label" style="display:none; padding-top:2px; font-size:16px;">
						' . __( '', 'woocommerce' ) . ' <span class="from"></span> &mdash; <span class="to"></span>
					</div>
					' . $fields . '
					<div class="clear"></div>
				</div>
